...
add wave -noupdate -expand -group ULA /CPU/ALU/A
add wave -noupdate -expand -group ULA /CPU/ALU/B
add wave -noupdate -expand -group ULA -radix decimal /CPU/ALU/S
add wave -noupdate -expand -group ULA /CPU/ALU/Seletor
add wave -noupdate -expand -group ULA /CPU/ALU/Menor
add wave -noupdate -expand -group ULA /CPU/ALU/Maior
add wave -noupdate -expand -group ULA /CPU/ALU/Igual
...
WaveRestoreCursors {{Cursor 1} {1957 ps} 0}
...
update
WaveRestoreZoom {1655 ps} {3702 ps}
